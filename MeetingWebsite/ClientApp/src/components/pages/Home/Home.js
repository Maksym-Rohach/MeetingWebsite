            ...
            <Col xs="12" sm="6" md="4">
              <Card className="border-primary">
                ...
                <div><img alt ="photo" className ="img-fluid" src="https://i.pinimg.com/564x/00/97/1b/00971b1a4b0e1fd3b369cfc14b3f5a13.jpg" />
                  ...
                  <div><a href="#" className="social-link rounded-circle text-white mr-3">See Profile</a>
                  </div>
                  </CardBody>
              </Card>
            </Col>
            ...
            <div className="container ">
              <div className="row text-center slws-heading mb-3 animated fadeInUp  delay-1s">
                <div className="col-md-8 offset-md-2 ">
                  <h2 className="display-4 font-italic"> Що таке кохання?</h2>
                  <p className="sub-heading ">Коли він брав у руки скрипку, все на світі зникало, залишалась лише музика.></p>
                </div>
              </div>
            ...
            <div className="animated fadeIn">
                <Container>
                   <Row >
                       <Col xs="12" xl="12" >
<Carousel  
  className="Carousel-fixed-top blur" className="col-sm-6"
  interval={false}
  ride={true}
